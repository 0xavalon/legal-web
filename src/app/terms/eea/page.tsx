    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-8 mb-8 prose prose-sm max-w-none">
          ...
          <div className="mt-12 p-6 bg-blue-50 dark:bg-blue-900/30 border-l-4 border-blue-400 dark:border-blue-500 rounded-lg">
            <p className="text-sm text-blue-700 dark:text-blue-100 mb-4">
              The complete EEA Terms of Service contains detailed sections on:
              Glossary, Who can use our Services, Wind Technologies Account,
              Uploading and Converting Money, Money Transfer, Intellectual
              Property Rights, Third Party Materials, Other Legal Terms, and
              more.
            </p>
            <a
